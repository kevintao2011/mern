...
// import BrandProductList from '../../model/interface.ts'
const Cart = () => {
  ...
  useEffect(() => { 
    console.log('Cart Page Information')
    console.log('Social Map',SocMap)
    console.log('Cart',Cart)
    // console.log('Mapped Cart', groupCartProductByOrg(Cart))
